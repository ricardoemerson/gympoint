...
<h3 align="center">
  Resolução do desafio do Bootcamp GoStack 9.0 da Rocketseat sobre NodeJS.
</h3>

<h3 align="center">
  #rocketseat, #nodejs, #express, #sequelize
</h3>

Para este desafio a API do backend foi criada utilizando NodeJS com express. O banco de dados utilizado é o Postgresql.

Também está sendo utilizado o Redis com a biblioteca bee-queue para execução de jobs, como email, em segundo plano.

Abaixo todos os requisitos solicitados para a realização do desafio da aplicação final do curso.
